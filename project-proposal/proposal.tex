...
\def\dissertationtitle{Advantages of parallel compared with serial computation,
for route-planning problems and how increased data size may affect this}
...
Prof L. C. Paulson % TODO: title right

\paragraph{Project overseers:}%
\label{par:Project Overseers:}
Prof R. Mantiuk \& Prof A. M. Pitts % TODO: titles right?
...
(an Intel i5-8300H @ 2.30Ghz), 8 GB of RAM, and an NVIDIA GTX 1050 Mobile.  I
...
\marginpar{\scriptsize \textbf{Comment to overseers:} I have mainly focused on the work items
when writing this timetable draft. I am not sure how time-consuming each of them are,
prior to doing research and planning. I am also uncertain how many weeks should be set aside
for extension work.}
