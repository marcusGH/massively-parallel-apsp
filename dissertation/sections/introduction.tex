...
aim, I simulate a parallel system with characteristics based on real hardware.
...
watt to keep increasing by combing many processing elements (\acp{PE}). 
Today, there are various  different parallel systems.
...
automatic parallelisation can increase performance of a
serial algorithm.
...
utilise the available \acp{PE} fully and increase performance to a high
degree.
...
Additionally, their test graphs are dense, randomly generated graphs, not based
