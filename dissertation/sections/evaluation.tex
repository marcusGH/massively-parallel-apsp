...
% TODO list:
% * Check if all plots look nice in half-scale, then compile the 6 plots,
%   one version without errorbars, then put them with in the appendix for
%   reference
% * Also create plots for the California road network
