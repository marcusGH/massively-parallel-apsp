...
I am very grateful to the following people for providing suggestions or helping
me through other means:
\begin{itemize}
    \item \textbf{Dr Jagdish Modi}, for supervising the project and being available to give feedback and advice throughout the whole process.
    \item \textbf{Professor Lawrence Paulson}, for providing feedback on the final versions of my dissertation.
    \item \textbf{\citeauthor{graph-dataset}}, for cleaning up and making several road-network datasets easily available \cite{graph-dataset}.
\end{itemize}
...
{\large
    \begin{tabular}{p{120pt}p{311pt}}
        ...
        Word Count:         & \bf 11670\footnotemark[1]   \\
        Final line count : &  \bf 4010 (Java, \texttt{main/}) + 1870 (Java, \texttt{test/}) + 729 (Python)\footnotemark[2] \\
...
\footnotetext[2]{See \cref{sec:Final line count} for the exact commands used to find the line count.}
