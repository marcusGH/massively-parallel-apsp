...
The parallel system simulation sprouts out from the \texttt{Worker}
...
$\lceil n / p \rceil \times \lceil n / p \rceil$. For example, \ac{PE} with
id $(0,0)$ in ... would have .... $A,B,P[0\dots 1,2\dots 3]$. It would also be
...
$M_{dist}[0\dots 1, 2\dots 3]$. We will abbreviate the submatrix size
